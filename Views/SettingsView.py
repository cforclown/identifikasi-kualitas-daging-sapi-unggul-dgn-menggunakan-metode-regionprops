...
################################################################################
## Form generated from reading UI file 'SettingsViewdxZKay.ui'
##
...
class Ui_SettingsView(object):
    def setupUi(self, SettingsView):
        ...
        self.gridLayout.addWidget(self.separator, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.detectionParamsText, 3, 0, 1, 1)
    ...
    def retranslateUi(self, SettingsView):
        ...
        self.lowRedValueText.setText(QCoreApplication.translate("SettingsView", u"LOW RED [170, 0, 0] [180, 255, 255]\n"
"MEDIAN BLUR 5", None))
        self.highRedValueText.setText(QCoreApplication.translate("SettingsView", u"HIGH RED [0, 0, 0] [30, 255, 255]\n"
"MEDIAN BLUR 5", None))
